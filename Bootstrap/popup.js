...
function setup_event(event){
    ...
    setTimeout(function(){ alert(event.title + " will start at " + start.getHours() + ":" + start.getMinutes() + " on " + months[start.getMonth()] + " " + start.getDate() + ", " + start.getFullYear() )}, timer_sec * 1000);
}
...
function setup_task(task){
    ...
    setTimeout(function(){ alert(task.title + " is due at " + start.getHours() + ":" + start.getMinutes() + " on " + months[start.getMonth()] + " " + start.getDate() + ", " + start.getFullYear() )}, timer_sec * 1000);
...
function setup_block(block){
    ...
    setTimeout(function(){ alert(block.name + " will start at " + start.getHours() + ":" + start.getMinutes() + " on " + months[start.getMonth()] + " " + start.getDate() + ", " + start.getFullYear() )}, timer_sec * 1000);
