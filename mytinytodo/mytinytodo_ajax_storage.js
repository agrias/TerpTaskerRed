...
mytinytodoStorageAjax.prototype = 
{
	...
	{
		$.getJSON(this.mtt.mttUrl+'ajax.php?loadLists'+'&rnd='+Math.random()+'&id='+params.id, callback);
	},
...
*/
		...
		$.getJSON(this.mtt.mttUrl+'ajax.php?loadTasks&list='+params.list+'&compl='+params.compl+'&sort='+params.sort+q+'&id='+params.id+'&context='+params.context, callback);
	},
	...
	newTask: function(params, callback)
	{
		$.post(this.mtt.mttUrl+'ajax.php?newTask',
			{ list:params.list, title: params.title, tag:params.tag, id: params.id }, callback, 'json');
	},
	...
	fullNewTask: function(params, callback)
	{
		$.post(this.mtt.mttUrl+'ajax.php?fullNewTask',
			{ list:params.list, title:params.title, note:params.note, prio:params.prio, tags:params.tags, duedate:params.duedate, estMins:params.estMins, 				estHours:params.estHours, contexts:params.contexts, duetime: params.duetime, ereminder: params.ereminder, preminder: params.preminder, id:params.id }, callback, 'json');
	},
	...
	editTask: function(params, callback)
	{
		$.post(this.mtt.mttUrl+'ajax.php?editTask='+params.id,
			{ id:params.id, title:params.title, note:params.note, prio:params.prio, tags:params.tags, duedate:params.duedate, estMins:params.estMins, estHours:params.estHours, 				contexts: params.contexts, duetime: params.duetime, ereminder: params.ereminder, preminder:params.preminder, userId:params.userId}, callback, 'json');
	},

	setEst: function(params, callback)
	{
		$.post(this.mtt.mttUrl+'ajax.php?setEst='+params.id, {id:params.id, estMins:params.estMins, estHours:params.estHours}, callback);
	},
	...
	{
		$.post(this.mtt.mttUrl+'ajax.php?completeTask='+params.id, { id:params.id, compl:params.compl, userId:params.userId }, callback, 'json');
	},
	...
	{
		$.post(this.mtt.mttUrl+'ajax.php?addList', { name:params.name, id:params.id }, callback, 'json'); 

	},

	getContexts: function(params, callback)
	{
		$.post(this.mtt.mttUrl+'ajax.php?getContexts', {id: params.id }, callback, 'json');
	},

	getDefaults: function(params, callback)
	{
		$.post(this.mtt.mttUrl+'ajax.php?getDefaults', {id:params.id}, callback, 'json');
	},
