...
<div id="htab_search">
 <table class="mtt-searchbox"><tr><td>
  <div class="mtt-searchbox-c">
   ...
   <label id="search_placeholder" class="placeholding" for="search">
   <span><?php _e('htab_search');?></span>
   </label>
  ...
  <div class="mtt-tb-c">
   <form id="newtask_form" method="post">
    <label id="task_placeholder" class="placeholding" for="task">
     <input type="text" name="task_bar" value="" maxlength="250" id="task_bar" autocomplete="off" />
...
<div class="form-row form-row-short">
 ...
 <select name="prio" class="select-class">
...
<div class="form-row form-row-short">
 ...
 <input type ="text" name="duedate" id="duedate" value="" class="in100" title="Y-M-D, M/D/Y, D.M.Y, M/D, D.M" autocomplete="off" />
 <span class="h">At</span>
 <input type="text" name="duetime" id="duetime" value="00:00" class="in30" title="HH:MM" maxlength="5"/>

 <span class="h"><?php _e('estimation');?> </span>
 <input type="text" name="estHours" id="estHours" value="0" class="in25" maxlength="3"/>
 <?php _e('hours');?>
 <select name="estMins" class="select-class">
  <option value="0" selected="selected">0</option><option value="15">15</option><option value="30">30</option><option value="45">45</option>
 </select>
 <?php _e('minutes');?>
</div>
...
<div class="form-row form-row-short">
 <span class="h"><?php _e('context');?> </span>
 <select name="contexts" id ="contexts" class="select-class">
  <option value = "default1">default1</option><option value="default2">default2</option>
 </select>
 <!--<a href="#" id="add_context"><?php _e('add_context');?></a>
 <a href="#" id="remove_context"><?php _e('remove_context');?></a> -->
</div> 
...
<div class="form-row form-row-short"><span class="h">Remind Me With E-mail</span> 
<select name="emailReminder" id="emailReminder" class="select-class email">
...
</select><span class="h">Before Due Date</span></div>
<div class="form-row-short-end"></div>
<div class="form-row form-row-short"><span class="h">Remind Me With pop-up</span> 
<select name="popupReminder" id="popupReminder" class="select-class">
<option value="-1">never</option>
<option value="600">10 minutes</option>
<option value="1800">30 minutes</option>
<option value="3600">1 hour</option>
