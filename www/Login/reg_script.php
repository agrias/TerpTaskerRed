...
else if ($insert_stmt = $mysqli->prepare("INSERT INTO members (firstname, lastname, active, email, password, salt, Administrator) VALUES (?, ?, ?, ?, ?, ?,?)")) {    
   $insert_stmt->bind_param('ssisssi', $firstname, $lastname, $active, $email, $password, $random_salt, $admin); 
